 ...
 * @author iMinusMinus
 */
public class RuleApolloProvider<E extends RuleEntity> implements DynamicRuleProvider<List<E>> {
    ...
    public RuleApolloProvider(Function<String, String> appNameToAppId,

...
public class AuthController {
    ...
    public Result<AuthService.AuthUser> login(HttpServletRequest request,
        ...
        /*
         * If username or password is blank(set in application.properties or VM arguments),
         ...
         */
        if (StringUtils.isNotBlank(dashboardProperties.getAuth().getUsername())
                && !dashboardProperties.getAuth().getUsername().equals(username)
                || StringUtils.isNotBlank(dashboardProperties.getAuth().getPassword())
                && !dashboardProperties.getAuth().getPassword().equals(password)) {
